...
export class InitialMigration1618642989148 implements MigrationInterface {
    name = 'InitialMigration1618642989148'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `record` (`id` varchar(128) NOT NULL, `group` varchar(255) NOT NULL, `bucket` varchar(255) NOT NULL, `provider` varchar(255) NOT NULL, `timestamp` int UNSIGNED NOT NULL, `offset` smallint NULL, `data` text NOT NULL, INDEX `IDX_419d1dbe0cd5a4ba0ef1747d28` (`group`), INDEX `IDX_b3947ba90f0925f2a6f6dd7a79` (`bucket`), INDEX `IDX_779ab0c6ed67cbb7b3491da5c7` (`provider`), INDEX `IDX_f6c41a1fdf16e6e21160326f64` (`timestamp`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `automation_instance` (`id` int UNSIGNED NOT NULL AUTO_INCREMENT, `automation` varchar(128) NOT NULL, `name` varchar(128) NOT NULL, `options` text NOT NULL, `schedule` varchar(128) NULL, `isOn` tinyint NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("DROP INDEX `IDX_419d1dbe0cd5a4ba0ef1747d28` ON `record`");
